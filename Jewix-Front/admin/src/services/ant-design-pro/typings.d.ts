...
declare namespace API {
    ...
    type FetchRoleResourcesResponse = {
        id: number;
        resourceListPageDTOList: API.FetchResourceResponse[];
        roleLabel: string;
        roleName: string;
    };
    type UpsertRoleMenusBody = {
        menuIds: number[];
        roleId: number;
    };
    type UpsertRoleResourcesBody = {
        resourceIds?: number[];
        roleId?: number;
    };
    ...
    type FetchResourceResponse = {
        ...
        parentId: number;
        route: string;
        resourceSons: API.FetchResourceResponse[];
    };
